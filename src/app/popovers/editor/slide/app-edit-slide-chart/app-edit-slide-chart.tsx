...
import { SlideAttributesYAxisDomain } from '@deckdeckgo/editor';
...
export class AppEditSlideChart {
  ...
  async componentWillLoad() {
    ...
    this.datePattern = this.selectedElement
      ? this.selectedElement.getAttribute('date-pattern')
      : undefined;
    this.yAxisDomain =
    ...
    this.smooth = this.selectedElement
      ? this.selectedElement.getAttribute('smooth') === 'false'
        ? false
        : true
      : true;
    this.area = this.selectedElement
      ? this.selectedElement.getAttribute('area') === 'false'
        ? false
        : true
      : true;
    this.grid = this.selectedElement
      ? this.selectedElement.getAttribute('grid') === 'true'
        ? true
        : false
      : false;

    this.ticks = this.selectedElement
      ? this.selectedElement.getAttribute('ticks')
      : undefined;

    this.separator = this.selectedElement
      ? this.selectedElement.getAttribute('separator')
      : undefined;

    this.innerRadius = this.selectedElement
      ? this.selectedElement.getAttribute('inner-radius')
      : undefined;
  }
    ...
    return (
      <Host>
        ...
        <ion-item class='action-button ion-margin-top'>
          <ion-button
            shape='round'
            onClick={() => this.action.emit(EditAction.OPEN_DATA)}
            color='tertiary'>
    ...
    return [
      ...
      <ion-item class='select'>
        ...
        <ion-select
          ...
          <ion-select-option value='extent'>
