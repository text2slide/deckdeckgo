...
export class AppDeck {
	...
	private renderEditMode() {
		if (
			[TargetElement.TEXT, TargetElement.BACKGROUND].includes(
				this.applyToTargetElement
			)
		) {
		...
		if (this.applyToTargetElement === TargetElement.TEXT) {
			return (
				<app-deck-fonts
					...
					onFontsChange={() => this.onDeckChange()}></app-deck-fonts>
			);
			...
			return (
				<app-deck-transition
					deckElement={this.deckElement}
					onTransitionChange={() => this.onDeckChange()}></app-deck-transition>
			);
