...
export class AppRoot {
	...
	async componentWillLoad() {
		this.destroyAuthListener = authStore.onChange(
			'authUser',
			async () => await initSyncState()
		);
	...
	async componentDidLoad() {
		this.destroyErrorListener = errorStore.onChange(
			'error',
		...
		this.destroyNavListener = navStore.onChange(
			'nav',
			async (params: NavParams | undefined) => {
