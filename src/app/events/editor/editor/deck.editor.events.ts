...
export class DeckEditorEvents {
	...
	init({
		...
		mainRef: HTMLElement;
		actionsEditorRef: HTMLAppActionsDeckEditorElement | undefined;
	}): Promise<void> {
		return new Promise<void>(async (resolve) => {
			...
			document.addEventListener('drrSelectText', this.onDraggableResizableSelect);
	...
	destroy() {
		...
		document.removeEventListener(
			'drrSelectText',
			this.onDraggableResizableSelect
		);
	}
