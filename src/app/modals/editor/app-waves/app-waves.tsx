...
export class AppWaves {
	...
	private async generateWaves(mirror: boolean = false) {
		...
		const fullPath: string = WavesUtils.getFullPath(
			this.nodes,
			this.orientation,
			this.coordinates
		);
