...
import { UserSocial } from '../../stores/user.store';
	...
	private static createCustomLogo(user: User): JSX.IntrinsicElements {
		if (user.data.social.custom_logo_url) {
			return (
				<deckgo-lazy-img
					slot='icon'
					img-src={user.data.social.custom_logo_url}
					aria-label='Web'></deckgo-lazy-img>
			);
		}
		...
		return (
			<deckgo-lazy-img
				slot='icon'
				svg-src={`${config.globalAssetsUrl}/icons/ionicons/globe.svg`}
				aria-label='Web'></deckgo-lazy-img>
		);
	}
	...
	static createGitHub(user: User): JSX.IntrinsicElements {
		...
		return (
			<deckgo-social slot={`social-link`} github={user.data.social.github}>
				<deckgo-lazy-img
					slot='icon'
					svg-src={`${config.globalAssetsUrl}/icons/ionicons/github.svg`}
					aria-label='GitHub'></deckgo-lazy-img>
			</deckgo-social>
		);
	}
	...
	static createMedium(user: User): JSX.IntrinsicElements {
		...
		return (
			<deckgo-social slot={`social-link`} medium={user.data.social.medium}>
				<deckgo-lazy-img
					slot='icon'
					svg-src={`${config.globalAssetsUrl}/icons/medium.svg`}
					aria-label='Medium'></deckgo-lazy-img>
			</deckgo-social>
		);
	}
	...
	static createDev(user: User): JSX.IntrinsicElements {
		...
		return (
			<deckgo-social slot={`social-link`} dev={user.data.social.dev}>
				<deckgo-lazy-img
					slot='icon'
					svg-src={`${config.globalAssetsUrl}/icons/dev.svg`}
					aria-label='Dev'></deckgo-lazy-img>
			</deckgo-social>
		);
	}
