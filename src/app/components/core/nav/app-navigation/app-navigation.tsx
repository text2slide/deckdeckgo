...
export class AppNavigation {
	...
	@State()
	private hideIC: boolean =
		localStorage.getItem('deckgo-hide-announcement-ic') !== null;
	...
	private renderStart() {
		return (
			<ion-buttons slot='start'>
				<ion-menu-toggle>
					<ion-button aria-label={i18n.state.nav.menu} color='dark'>
						<AppIcon
							name='menu'
							ariaHidden={true}
							ariaLabel=''
							slot='icon-only'></AppIcon>
					</ion-button>
				</ion-menu-toggle>

				{this.actions === 'all' ? (
					<app-navigation-start></app-navigation-start>
				) : undefined}
			</ion-buttons>
		);
	}
