...
export const AppAssetChoice: FunctionalComponent<AppAssetChoiceProps> = ({
	selectAction,
}) => {
	const renderStockPhotos = () => {
		...
		return (
			<ion-button
				shape='round'
				onClick={async () => await selectAction(EditAction.OPEN_UNSPLASH)}
				color='primary'>
	...
	const renderGif = () => {
		...
		return (
			<ion-button
				shape='round'
				onClick={async () => await selectAction(EditAction.OPEN_GIFS)}
				color='secondary'>
	...
	const renderCustom = () => {
		return (
			<ion-button
				shape='round'
				onClick={async () => await selectAction(EditAction.OPEN_CUSTOM)}
				color='tertiary'>
