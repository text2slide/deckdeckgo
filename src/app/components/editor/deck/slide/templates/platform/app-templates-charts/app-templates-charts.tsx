...
export class AppTemplatesCharts {
	...
	private async lazyLoadAllCharts() {
		const slidesCharts: HTMLDeckgoSlideChartElement[] = Array.from(
			this.el.querySelectorAll('deckgo-slide-chart.showcase')
		);
	...
	private async animate() {
		this.timerInterval = setInterval(async () => {
			const elements: NodeListOf<HTMLElement> = this.el.querySelectorAll(
				'deckgo-slide-chart[animation]'
			);
		...
		return [
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						...
						attributes: { type: SlideChartType.PIE },
					})
				}>
				{/* Pie */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType.PIE, innerRadius: 100 },
					})
				}>
				{/* Donut */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType.PIE, animation: true },
					})
				}>
				{/* Animated Pie */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType.LINE },
					})
				}>
				{/* Area */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType.LINE, smooth: false },
					})
				}>
				{/* Sharp area */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType.LINE, area: false },
					})
				}>
				{/* Lines */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType.LINE, animation: true },
					})
				}>
				{/* Animated area */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType.BAR },
					})
				}>
				{/* Bar */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType.BAR, animation: true },
					})
				}>
				{/* Animation bars */}
				<deckgo-slide-chart
			...
			<div
				...
				onClick={() =>
					this.selectedTemplate.emit({
						template: SlideTemplate.CHART,
						attributes: { type: SlideChartType['HORIZONTAL-BAR'] },
					})
				}>
				{/* Horizontal Bar */}
				<deckgo-slide-chart-custom
					...
					src={assetsStore.state.chart.barCompareSrc}
					custom-loader={true}>
					<p slot='title'>{i18n.state.templates.horizontal_bar}</p>
				</deckgo-slide-chart-custom>
			</div>,
		];
	}
