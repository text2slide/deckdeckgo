...
export const AppTemplatesFixed: FunctionalComponent<AppTemplatesFixedProps> = ({
	selectTemplate,
	selected,
}) => {
	const renderTitle = () => {
		return (
			<app-templates-title
				...
				onClick={() =>
					selectTemplate({ template: SlideTemplate.TITLE })
				}></app-templates-title>
		);
	};
		...
		return (
			<Fragment>
				<app-templates-content
					...
					onClick={() =>
						selectTemplate({ template: SlideTemplate.CONTENT })
					}></app-templates-content>
				<app-templates-content
					custom-tappable
	...
	const renderSplit = () => {
		return (
			<app-templates-split
				...
				onClick={() =>
					selectTemplate({ template: SlideTemplate.SPLIT })
				}></app-templates-split>
		);
	};
