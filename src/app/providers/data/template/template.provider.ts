...
export const initTemplates = async () => {
	...
	try {
		const { getUserTemplates }: { getUserTemplates: GetUserTemplates } =
			await cloudProvider<{ getUserTemplates: GetUserTemplates }>();
...
export const createUserTemplate = async (
	...
	const { createTemplate }: { createTemplate: CreateTemplate } =
		await cloudProvider<{ createTemplate: CreateTemplate }>();
...
export const updateTemplate = async (
	...
	const { updateTemplate }: { updateTemplate: UpdateTemplate } =
		await cloudProvider<{ updateTemplate: UpdateTemplate }>();
