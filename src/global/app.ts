...
setupDeckGoConfig({
	...
	deckdeckgo: {
		...
		globalAssetsUrl: '<@ASSETS_URL@>',
		navigateReloadEditorUrl: '<@EDITOR_URL@>',
...
log.apply(console, [
	'%cDeckDeckGo',
	'color: #3880ff;font-size:2rem;font-weight: 300;',
]);
log.apply(console, [
...
log.apply(console, [
	'%cCome say hi and contribute to our project on Github',
	'color: black;font-size:1rem;font-weight: 300;',
]);
log.apply(console, [
	'%chttps://github.com/deckgo/deckdeckgo',
